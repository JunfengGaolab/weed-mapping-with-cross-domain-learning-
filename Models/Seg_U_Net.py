...
def Seg_UNet(nClasses, input_height, input_width, kernel=3, pool_size=(2, 2), output_mode="softmax"):
    ...
    conv_29 = Convolution2D(nClasses, (1, 1), padding="valid")(conv_28)
    conv_29 = BatchNormalization()(conv_29)
    # conv_29 = Reshape(
    #         (input_shape[0] * input_shape[1], nClasses),
    #         input_shape=(input_shape[0], input_shape[1], nClasses))(conv_29)
